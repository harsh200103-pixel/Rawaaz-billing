...
const CONFIG = {
  ...
  city:      'Indore',
  currency:  '₹',
  categories: ['Unstitched Suit', 'Stitched Suit', 'Rumalla Saheb', 'Kurtis', 'Customised'],
      ...
      <tr>
        ...
        <td>
          <div style="display:flex;gap:6px;flex-wrap:wrap">
            <button class="btn btn-sm btn-whatsapp" onclick="Share.openShareModal(Store.getBill('${b.id}'))">📱 Share</button>
            <button class="btn btn-sm btn-ghost" onclick="Print.bill(Store.getBill('${b.id}'))">🖨️</button>
